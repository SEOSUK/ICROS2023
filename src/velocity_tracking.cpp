...
//		Jacobian_inverse = solve_Jacobian_Inverse(measured_angle[0], measured_angle[1], Link1, Link2);
	...
	//------------------------------------------------//
//service server callback을 만들어서 joint1, joint2 각각 받을 수 있게 
	...
	//---------------포지션 에러 구하기 ---------------//
		...
		// position_dot_gain[0] = sinu;
		// position_dot_gain[1] = 0;

		angular_velocity_command = Jacobian_transpose * position_dot_gain;
